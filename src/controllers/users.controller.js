...
const changeCurrentPassword = asyncHandler(async(req,res)=>{
    ...
    return res
        .status(200)
        .json( new ApiResponce( 200 ,{} , " password changed"))
...
const updateCoverImage = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponce(200, existingUser, "Cover image updated successfully")
    );
});
...
const getUserChannelProfile = asyncHandler(async(req,res)=>{
    ...
    return res
        .status(200)
        .json(new ApiResponce(200,channel[0],"uchannel fetched successfully"))
